const b2t = (beats, tempo) => 60 / (beats * tempo);
const noteFrequency = {
    C0: 16.35,
    D0: 18.35,
    E0: 20.6,
    ...
    function playData(data, type, outputNode, absolute = false) {
        return new Promise((resolve) => {
            ...
            data.forEach(([frequency, startTime, durationOrEndTime, volume, detune]) => {
                ...
                oscillate(oscillator, gain, 0, absolute ? durationOrEndTime : startTime + durationOrEndTime, volume, detune);
            });
        });
    }
